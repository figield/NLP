...
class DBmanager:
    ...
    def insertIrregularVerbAdvance(self, verb1, verb2, verb3, verb4, verb5):
        query = "INSERT INTO irregularVerbsAdvance(verb1, verb2, verb3, 3rd, pp_ing) VALUES ('" + verb1 + "','" + verb2 + "', '" + verb3 + "', '" + verb4 + "', '" +verb5 +"')" 
    	self.cur.execute(query)	  
	return 1
