...
class DBmanager:
    ...
    def insertTranslation(self, word, translation, id_description, id_gender):
        query = "INSERT INTO dictionary(word, translation, id_description, id_gender) VALUES ('" + word + "','" + translation + "', " + str(id_description) + ", " + str(id_gender) +")" 
        #print query
    ...
    def selectTranslationTest(self):
